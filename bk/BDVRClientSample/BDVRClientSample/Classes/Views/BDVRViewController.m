...
#define API_KEY @"shXg2pvfb6EUGSGO9ESu6Cbu" // 请修改为您在百度开发者平台申请的API_KEY
#define SECRET_KEY @"gudZf0y0XGayeQY1OyiEboAUN2OsRA2N" // 请修改您在百度开发者平台申请的SECRET_KEY


#define APPID @"3076964" // 请修改为您在百度开发者平台申请的APP ID
...
//    self.rawDataRecognizer.licenseFilePath= [[NSBundle mainBundle] pathForResource:@"bdasr_license" ofType:@"dat"];
